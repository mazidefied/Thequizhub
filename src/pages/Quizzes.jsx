    ...
    <div className='page quizzes'>
      <div className="content">
        ...
        <section>
          ...
          {quizzesData.quizzes.length > 0 ? <div className="quiz-container">
          ...
          </div> : <><h1>Didn't find any Quizzes</h1><small><i>If you are the owner of this project add quizzes into the tests.js folder using the testsTemp.js folder as a reference. Goodluck</i></small></>}
        </section>
      </div>
    </div>
  )
