...
const Quiz = () => {
    ...
    useEffect(() => {
        ...
        if (possibleQuizzes.length > 0 && isFetching) {
            ...
            const questionsXX = shuffleArray(thisQuiz.questions)
    ...
    return (
        <div
            className={`page quiz-big ${appState.uiState.quizPage.startedQuiz ? 'started' : ''} ${appState.uiState.quizPage.timeUp ? 'time-up' : ''}`}>
            <div className="content">
                ...
                <div className="intro">
                    ...
                    <div className="rules">
                        ...
                        <ul>
                            <li>You have <b>{quizData.timer.minutes}</b> minutes{quizData.timer.seconds > 0 &&
                                <b>{`, ${quizData.timer.seconds} seconds `}</b>} to complete this quiz
                            </li>
                    ...
                    <div className="more-info">
                        ...
                        <ul>
                            <li>Powered By <a href='https://wa.me/+2349032698998'
                                              style={{color: "#000", textDecoration: "none",}}><b>IGNITION LABZ
                                ⚡</b></a></li>
                        </ul>
                    </div>
                    <div className="footer">
                        {quizData.questions.length > 0 && <button onClick={() => {
                            appState.functions.startQuiz({
                                minutes: quizData.timer.minutes,
                                seconds: quizData.timer.seconds
                            })
                ...
                <div className={`quiz-started ${showPagination ? "handle-pagination" : ""}`}>
                    <div className="heading">
                        <div className="quiz-name">
                            ...
                            <div className={showPaginationContent ? "quiz-progress close-pagination" : "quiz-progress "}
                                 onClick={() => {
                    ...
                    <div className={`questions-container ${showPaginationContent ? "show-pagination" : ""}`}>
                        ...
                        <div className="actions">
                            <div className="controls">
                                ...
                                {(activeIndex + 1) < quizData.questions.length ?
